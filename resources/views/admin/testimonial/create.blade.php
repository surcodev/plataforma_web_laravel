        ...
        <div class="section-body">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form id="admin-testimonial-create-form" action="{{ route('admin_testimonial_store') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group mb-3"
                                    ...
                                    data-form="#admin-testimonial-create-form"
                                    data-required="true"
                                    data-required-message="Selecciona y recorta la foto del testimonio antes de guardar."
                                    data-aspect-ratio="1"
                                    ...
                                    <label for="admin_testimonial_photo_source" class="d-block mb-1">Foto *</label>
                                    ...
                                    <div id="admin_testimonial_photo_preview_wrapper" class="mt-3 d-none">
                                        <label>Vista previa</label>
                                        <div class="admin-image-cropper-preview" style="--image-cropper-preview-ratio: 1; --image-cropper-preview-width: 220px;">
                                            <img id="admin_testimonial_photo_preview" src="" alt="Vista previa">
                                        </div>
