            ...
            <nav class="navbar navbar-expand-md navbar-light">
                <a class="navbar-brand d-flex align-items-center" href="{{ route('home') }}">
                    ...
                    <div class="ml-3 d-flex flex-column justify-content-center text-center">
                        <span style="font-family: 'Cinzel Decorative', serif; font-weight: 600; font-size: 24px; line-height: 1; color:#0c1a36;">
                            SANTA CLARA
                        </span>
                        <span style="font-size: 14px; letter-spacing: 1px; color:#0c1a36; text-transform: uppercase;">
                            Bienes Raíces
                        </span>
                    </div>
                </a>
