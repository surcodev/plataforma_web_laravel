...
<div class="home-wsp-mobile d-xl-none">
    <div class="container">
        @include('front.partials.whatsapp-property-form', ['suffix' => 'mobile'])
    </div>
</div>
...
<div class="property d-flex" id="property">
    ...
    <div class="banner-right col-xl-4 d-none d-xl-block">
        ...
        @include('front.partials.whatsapp-property-form', ['suffix' => 'desktop'])
